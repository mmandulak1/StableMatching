...
echo "PII-SC Started for Random Inputs of size n=$2, $1 times" >> ./HPCLtests/HPCLruntimes.txt
...
echo "PII-SC Completed $1 trials after $minutes minutes and $secondsAfter seconds" >> ./HPCLtests/HPCLruntimes.txt
